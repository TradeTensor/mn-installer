...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tradetensor.conf'
CONFIGFOLDER='/root/.tradetensor'
COIN_DAEMON='tradetensord'
COIN_CLI='tradetensor-cli'
...
#Nodes
addnode=149.28.43.182
addnode=149.28.58.146
addnode=104.156.225.64
addnode=108.61.90.121
addnode=207.246.123.8
addnode=140.82.10.116
EOF
}
